 ...
 * @author victor
 */
public class SDES extends Encryption{
    
    int key = 0;
    
    public SDES(byte[] key){
        String s_key = new String(key, StandardCharsets.UTF_8);
        this.key = Integer.valueOf(s_key);
    }

    @Override
    public byte[] encrypt(byte[] plaintext) {
        String msg = new String(plaintext, StandardCharsets.UTF_8);
